...
public class BlogRecycleAdapter2 extends RecyclerView.Adapter<BlogRecycleAdapter2.ViewHolder> {

    public List<BlogPost2> blogList;
    ...
    public BlogRecycleAdapter2(List<BlogPost2> blogList, List<User> userList) {
